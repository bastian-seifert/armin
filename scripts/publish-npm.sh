...
# The published package must keep "main": "plugins/armin.ts" (opencode's
# server entrypoint detection) and the @opencode-ai/plugin dependency (the
# plugin cannot resolve the SDK otherwise — file:// installs never get an
